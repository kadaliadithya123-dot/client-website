...
const SiteContent = () => {
  ...
  return (
    <div>
      ...
      {addModalOpen && <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/50 p-4 pt-6"><div className="w-full max-w-md rounded-lg bg-white p-6"><div className="flex items-center justify-between"><h2 className="text-lg font-semibold text-navy-900">Add Content Field</h2><button onClick={() => setAddModalOpen(false)} className="text-steel hover:text-navy-900" aria-label="Close"><HiX size={22} /></button></div><form onSubmit={handleAddNew} className="mt-4 space-y-3">
